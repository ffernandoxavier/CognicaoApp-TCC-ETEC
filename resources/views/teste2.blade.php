...
<body>
    ...
    <br>
        ...
        <div class="custom-radio">
            <input id="radio-2" name="semana" value="2" type="radio" /> 
            <label id="txtrb" for="radio-2"> Segunda - Feira </label>
        </div>
        <div class="custom-radio">
            <input id="radio-3" name="semana" value="3" type="radio" /> 
            <label id="txtrb" for="radio-3"> Terça - Feira </label>
        </div>
        <div class="custom-radio">
            <input id="radio-4" name="semana" value="4" type="radio" /> 
            <label id="txtrb" for="radio-4"> Quarta - Feira </label>
        </div>
        <div class="custom-radio">
            <input id="radio-5" name="semana" value="5" type="radio" /> 
            <label id="txtrb" for="radio-5"> Quinta - Feira </label>
        </div>
        <div class="custom-radio">
            <input id="radio-6" name="semana" value="6" type="radio" /> 
            <label id="txtrb" for="radio-6"> Sexta- Feira </label>
        </div>
        <div class="custom-radio">
            <input id="radio-7" name="semana" value="7" type="radio"/> 
